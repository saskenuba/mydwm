...
static const char        *fonts[]           = { "CommitMono Nerd Font:size=9" };
static const char         dmenufont[]       = "CommitMono Nerd Font:size=9";
...
/* Tagging */
static const char *tags[] = { "term", "dev", "music", "etc", "5", "6", "comms", "front", "web" };
...
/* Media key command alternatives (comments) */
// Volume Up:   "pactl set-sink-volume @DEFAULT_SINK@ +5%" // "amixer sset Master 5%+"
// Volume Down: "pactl set-sink-volume @DEFAULT_SINK@ -5%" // "amixer sset Master 5%-"
// Mute Toggle: "pactl set-sink-mute @DEFAULT_SINK@ toggle" // "amixer sset Master toggle"
...
static const Button buttons[] = {
	...
	/* Duplicates removed in previous step
	{ ClkTagBar,            MODKEY,         Button1,        tag,            {0} },
	{ ClkTagBar,            MODKEY,         Button3,        toggletag,      {0} },
	*/
};
